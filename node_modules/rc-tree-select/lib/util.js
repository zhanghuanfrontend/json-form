...
function getFilterTree(treeNodes, searchValue, filterFunc, valueEntities) {
  ...
  function mapFilteredNodeToData(node) {
    ...
    var children = (0, _toArray2['default'])(node.props.children).map(mapFilteredNodeToData).filter(function (n) {
      return n;
    });
    ...
    if (children.length || match) {
      return _react2['default'].createElement(
        ...
        (0, _extends3['default'])({}, node.props, {
...
function processProps(props) {
  ...
  var cloneProps = (0, _extends3['default'])({}, props);
...
function convertDataToTree(treeData) {
  return (0, _util.convertDataToTree)(treeData, { processProps: processProps });
}
