...
var RangePicker = function (_React$Component) {
    ...
    _createClass(RangePicker, [{
        ...
        value: function render() {
            ...
            var clearIcon = !props.disabled && props.allowClear && value && (value[0] || value[1]) ? React.createElement(Icon, { type: 'close-circle', className: prefixCls + '-picker-clear', onClick: this.clearSelection, theme: 'filled' }) : null;
