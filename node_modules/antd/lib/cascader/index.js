...
var Cascader = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Cascader, [{
        ...
        value: function render() {
            ...
            var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(_icon2['default'], { type: 'close-circle', theme: 'filled', className: prefixCls + '-picker-clear', onClick: this.clearSelection }) : null;
            ...
            var inputProps = (0, _omit2['default'])(otherProps, ['onChange', 'options', 'popupPlacement', 'transitionName', 'displayRender', 'onPopupVisibleChange', 'changeOnSelect', 'expandTrigger', 'popupVisible', 'getPopupContainer', 'loadData', 'popupClassName', 'filterOption', 'renderFilteredOption', 'sortFilteredOption', 'notFoundContent', 'fieldNames', 'filedNames']);
            ...
            var inputIcon = suffixIcon && (React.isValidElement(suffixIcon) ? React.cloneElement(suffixIcon, {
                className: (0, _classnames2['default'])((_classNames4 = {}, (0, _defineProperty3['default'])(_classNames4, suffixIcon.props.className, suffixIcon.props.className), (0, _defineProperty3['default'])(_classNames4, prefixCls + '-picker-arrow', true), _classNames4))
            }) : React.createElement(
                'span',
            ...
            var expandIcon = React.createElement(_icon2['default'], { type: 'right' });
            var loadingIcon = React.createElement(
                'span',
                { className: prefixCls + '-menu-item-loading-icon' },
                React.createElement(_icon2['default'], { type: 'redo', spin: true })
            );
            var rest = (0, _omit2['default'])(props, ['inputIcon', 'expandIcon', 'loadingIcon']);
            return React.createElement(
                _rcCascader2['default'],
                (0, _extends3['default'])({}, rest, { options: options, value: value, popupVisible: state.popupVisible, onPopupVisibleChange: this.handlePopupVisibleChange, onChange: this.handleChange, dropdownMenuColumnStyle: dropdownMenuColumnStyle, expandIcon: expandIcon, loadingIcon: loadingIcon }),
                input
            );
        }
    }]);
